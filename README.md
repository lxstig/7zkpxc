...
- **Unique passwords per archive** 32-character cryptographically random, generated fresh every time.
...
| Weak / reused passwords | Every archive gets a unique 32-char random password. |
